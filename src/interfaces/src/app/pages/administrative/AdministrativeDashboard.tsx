  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Personal Administrativo</p>
      </div>
        ...
        <Card className="border-l-4 border-l-[var(--unsaac-red)]">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground mb-1">Mis solicitudes</p>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Button asChild className="h-24 bg-[var(--unsaac-red)] hover:bg-[var(--unsaac-red-dark)]">
              <Link to="/dashboard/administrative/new-request" className="flex flex-col gap-2">
                <FilePlus className="h-6 w-6" />
                <span>Nueva solicitud</span>
              </Link>
            </Button>
            <Button asChild variant="outline" className="h-24">
              <Link to="/dashboard/administrative/procedures" className="flex flex-col gap-2">
