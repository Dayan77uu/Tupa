...
ALTER TABLE `tlogin`
  ADD COLUMN `activada` TINYINT(1) NOT NULL DEFAULT 1
  COMMENT 'FALSE = login pendiente de activacion (hash actual es un secreto aleatorio descartado, no una contrasena real). Ver POST /api/auth/activar-cuenta.';
