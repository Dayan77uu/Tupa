...
INSERT IGNORE INTO `tperfildemo` (`dni`, `nombres`, `apellidos`, `carrera`, `correo`)
VALUES
  ...
  ('00000005', 'Estudiante Demo', 'Cinco', 'Contabilidad', 'demo.cinco@unsaac.edu.pe');
...
CREATE TABLE IF NOT EXISTS `thistorialcatalogo` (
  ...
  `usuario` VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
