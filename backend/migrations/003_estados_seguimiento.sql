...
ALTER TABLE `texpediente`
  MODIFY COLUMN `cestado` ENUM(
    'BORRADOR', 'RECIBIDO', 'PENDIENTE', 'EN_REVISION', 'OBSERVADO', 'APROBADO', 'RECHAZADO'
...
ALTER TABLE `texpediente`
  MODIFY COLUMN `cestado` ENUM(
    'BORRADOR', 'PENDIENTE', 'EN_REVISION', 'OBSERVADO', 'APROBADO', 'RECHAZADO'
  ) NOT NULL DEFAULT 'BORRADOR';
...
CREATE TABLE IF NOT EXISTS `tmovimientoexpediente` (
  ...
  `usuario_responsable` VARCHAR(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
