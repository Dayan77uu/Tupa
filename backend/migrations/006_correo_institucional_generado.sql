...
ALTER TABLE `talumno`
  ADD COLUMN `correo_institucional_generado` VARCHAR(100) NULL
  ...
  COMMENT 'GENERADO para el proyecto (autorizado por el docente 23/07/2026). No es el correo institucional oficial -- UNSAAC no expone ese dato en bdtupa.';
